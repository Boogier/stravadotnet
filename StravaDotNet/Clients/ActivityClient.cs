...
public class ActivityClient : BaseClient
{
    ...
    public async Task<List<Photo>> GetPhotosAsync(long activityId, int size)
    {
        var getUrl = $"{"https://www.strava.com/api/v3/activities"}/{activityId}/photos?access_token={Authentication.AccessToken}&size={size}";
